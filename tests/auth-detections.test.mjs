...
const mk=(i,over={})=>({timestamp:`2026-08-19T08:00:${String(i).padStart(2,'0')}Z`,rule:{level:5,id:'60122',description:'Logon Failure - Unknown user or bad password',groups:['windows','windows_security','authentication_failed']},agent:{id:'056',name:'SERVER01',ip:'10.22.42.11'},decoder:{name:'windows_eventchannel'},location:'EventChannel',data:{win:{system:{eventID:'4625',systemTime:`2026-08-19T08:00:${String(i).padStart(2,'0')}Z`,channel:'Security',computer:'SERVER01',providerName:'Microsoft-Windows-Security-Auditing',message:'An account failed to log on.'},eventdata:{targetUserName:'administrator',subjectUserName:'RDWebAccess',subjectDomainName:'IIS APPPOOL',logonType:'3',processName:'C:\\Windows\\System32\\inetsrv\\w3wp.exe',status:'0xc000006d',subStatus:'0xc000006a',...over}}}}});
{
