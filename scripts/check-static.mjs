...
const required=['index.html','app.css','log.css','soc.css','ops.css','v05.css','v06-ui.css','platform/platform.css','core.js','log-engine.js','log-worker.js','soc-engine.js','ops-engine.js','security-runtime.js','platform/app-bus.js','platform/investigation-engine.js','platform/detection-v3.js','platform/log-stream-client.js','platform/log-stream-worker.js','platform/event-explorer-v2.js','platform/investigation-ui.js','platform/global-search.js','platform/bootstrap.js','app.js','log-ui.js','soc-ui.js','ops-ui.js','ui-hardening.js','dashboard-v06.js','log-normalize-fixes.js','soc-v05-ui.js','favicon.svg','manifest.webmanifest','sw.js'];
